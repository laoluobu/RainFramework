...
insert into `SysMenus` values (1, '/roleManger', 'role/index.vue', '{\"icon\":\"el-icon-s-custom\"}',2,0,2,'roleManger');
insert into `SysMenus` values (3, '/menusManger', 'menu/index.vue', '{\"icon\":\"el-icon-notebook-2\"}',2,0,1,'menusManger');
INSERT INTO `SysMenus` VALUES(4, '/userManger', 'user/index.vue', '{"Icon": "el-icon-s-custom"}', 2, 0, 3, 'userManger');
